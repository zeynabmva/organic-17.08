...
// LOGIN
  ...
  const handleLogin = () => {
    // Burada giriş emeliyyatını tamamladıqdan sonra
    // aksiyonunu dispatch edin:
    dispatch(loginSuccess());
  };

  const handleLogout = () => {
    // Çıxış emeliyyatını burada həyata keçirin və
    // aksiyonunu dispatch edin:
    dispatch(logout());
  };
